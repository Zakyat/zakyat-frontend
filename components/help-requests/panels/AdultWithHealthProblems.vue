<template>
  <div>
    <v-expansion-panel-header>
      <h3>Взрослый, имеющии проблемы со здоровьем</h3>
    </v-expansion-panel-header>
    <v-expansion-panel-content class="mt-5">
      ...
      <div class="documents-title">
        ...
        <h2>Документы по нуждающемуся:</h2>
      </div>
      <ul class="pl-5 mt-3">
      ...
      <div class="documents-title mt-5">
        <img class="mr-3" width="25" :src="require('@/assets/images/help_request/info.svg')" alt="">
        <h2>Если человек недееспособен, нужно предоставить также документы опекуна:</h2>
      </div>
      <ul class="pl-5 mt-3">
